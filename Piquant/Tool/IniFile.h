...
public:
	...
	//外部使用接口，由于是静态函数，可直接CIniFile::静态函数名使用
	...
	static string GetValue(string KeyName, string SectionName, string FileName);	//获取section段第一个键为key的值,并将值赋到value中
