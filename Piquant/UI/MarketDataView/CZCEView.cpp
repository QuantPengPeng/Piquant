// CZCEView.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CCZCEView, CView)
...
BEGIN_MESSAGE_MAP(CCZCEView, CView)
	ON_WM_SIZE()
	ON_MESSAGE(WM_UPDATE_GRIDCTRL, &CCZCEView::OnUpdateGridCtrl)//将消息与消息映射函数相绑定
END_MESSAGE_MAP()


// CCZCEView drawing

void CCZCEView::OnDraw(CDC* pDC)
{
...
// CCZCEView diagnostics

#ifdef _DEBUG
void CCZCEView::AssertValid() const
{
	CView::AssertValid();
}

#ifndef _WIN32_WCE
void CCZCEView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}

void CCZCEView::OnReceiveData(WPARAM wParam, LPARAM lParam)
{
...
void CCZCEView::OnInitialUpdate()
{
...
// CCZCEView message handlers


void CCZCEView::OnSize(UINT nType, int cx, int cy)
{
...
LRESULT CCZCEView::OnUpdateGridCtrl(WPARAM wParam, LPARAM lParam)
{
	//CZCE
...
void CCZCE_ChildView::UpdateMarketDataView(LPARAM lParam)
{
