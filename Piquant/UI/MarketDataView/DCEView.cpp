// DCEView.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CDCEView, CView)
...
BEGIN_MESSAGE_MAP(CDCEView, CView)
	ON_WM_SIZE()
	ON_MESSAGE(WM_UPDATE_GRIDCTRL, &CDCEView::OnUpdateGridCtrl)//将消息与消息映射函数相绑定
END_MESSAGE_MAP()


// CDCEView drawing

void CDCEView::OnDraw(CDC* pDC)
{
...
// CDCEView diagnostics

#ifdef _DEBUG
void CDCEView::AssertValid() const
{
	CView::AssertValid();
}

#ifndef _WIN32_WCE
void CDCEView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}

void CDCEView::OnReceiveData(WPARAM wParam, LPARAM lParam)
{
...
// CDCEView message handlers


void CDCEView::OnSize(UINT nType, int cx, int cy)
{
...
LRESULT CDCEView::OnUpdateGridCtrl(WPARAM wParam, LPARAM lParam)
{
	//DCE
...
void CDCE_ChildView::UpdateMarketDataView(LPARAM lParam)
{
